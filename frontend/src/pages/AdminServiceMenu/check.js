...
import { reqCommentbyId, reqServicebyId, reqDelComment, acceptService, sendRequest } from '../../api'
  ...
  render() {
    ...
    const extra = (
      ...
      <Button type='primary' style={{
        ...
        const res = await acceptService("A19?dM83iN",this.state.service.provider,this.state.service.service)
      ...
      <Button  style={{
                  ...
                  const a = this.state.service.service
                  const b = this.state.service.price
                  const res = await sendRequest(storageUtils.getUser().username,this.state.service.provider,{a,b},"Your service was refused, please add a new one", "refuse service")
                  this.props.history.push('/manager/service/');
      }}
      >
